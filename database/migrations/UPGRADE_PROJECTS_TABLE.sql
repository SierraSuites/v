-- ============================================================
-- UPGRADE PROJECTS TABLE AND CREATE RELATED TABLES
-- Run this INSTEAD of PROJECTS_SQL_SETUP.sql if you already ran ESSENTIAL_SQL_SETUP.sql
-- ============================================================

-- Drop the existing basic projects table and recreate with full features
