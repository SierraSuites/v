-- ============================================================
-- UPGRADE TASKS TABLE
-- This script upgrades the basic tasks table to the full TaskFlow version
-- Run this INSTEAD of TASKFLOW_DATABASE_SETUP.sql if you already ran ESSENTIAL_SQL_SETUP.sql
-- ============================================================

-- Drop the existing basic tasks table and recreate with full TaskFlow features
