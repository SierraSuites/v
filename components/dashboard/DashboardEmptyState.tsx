  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-card rounded-xl shadow-sm p-8 mb-8">
        <h2 className="text-xl font-semibold text-foreground mb-6">Get Started in 3 Steps</h2>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              <h3 className="text-lg font-medium text-foreground mb-1">Create Your First Project</h3>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              <h3 className="text-lg font-medium text-foreground mb-1">Invite Your Team</h3>
              <p className="text-muted-foreground mb-3">
          ...
          <div className="flex items-start">
            ...
            <div className="ml-4 flex-1">
              <h3 className="text-lg font-medium text-foreground mb-1">Start Capturing Progress</h3>
              <p className="text-muted-foreground mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-card rounded-lg shadow-sm p-6">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-2">Project Analytics</h3>
        ...
        <div className="bg-card rounded-lg shadow-sm p-6">
          ...
          <h3 className="text-lg font-semibold text-foreground mb-2">Photo Management</h3>
          <p className="text-sm text-muted-foreground">
      ...
      <div className="mt-8 bg-muted rounded-lg p-6 text-center">
        <h3 className="text-lg font-medium text-foreground mb-2">Need Help Getting Started?</h3>
        <p className="text-muted-foreground mb-4">
          Check out our guides or contact support for assistance.
        </p>
        <div className="flex justify-center gap-4">
          <button className="inline-flex items-center px-4 py-2 border border-border bg-card text-foreground text-sm font-medium rounded-lg hover:bg-muted transition-colors">
            View Documentation
          </button>
          <button className="inline-flex items-center px-4 py-2 border border-border bg-card text-foreground text-sm font-medium rounded-lg hover:bg-muted transition-colors">
            Contact Support
