...
export default function DashboardStats({ stats: propStats }: { stats?: DashboardStatsData | null }) {
  const { colors, darkMode } = useThemeColors()
  const router = useRouter()
  const [stats, setStats] = useState<DashboardStatsData | null>(propStats ?? null)
