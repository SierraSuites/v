...
// Catches errors in app router pages and layouts
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center border border-gray-200">
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/dashboard"
            className="block w-full px-6 py-3 bg-white hover:bg-gray-50 text-gray-700 rounded-lg font-semibold transition-colors border border-gray-300"
          >
            Go to Dashboard
          </Link>
