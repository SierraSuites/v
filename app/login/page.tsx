...
function LoginForm() {
  ...
  return (
    <div className="force-light min-h-screen bg-background flex items-center justify-center px-4">
...
export default function LoginPage() {
  return (
    <Suspense fallback={
      <div className="force-light min-h-screen bg-background flex items-center justify-center">
